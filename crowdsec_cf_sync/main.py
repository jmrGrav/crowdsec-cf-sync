...
# ── Models (TypedDict) ────────────────────────────────────────────────────────
# Explicit schemas for recurring data structures. Pure typing — zero runtime
# cost, zero behavior change. All are structurally compatible with plain dict.
# Extracted to crowdsec_cf_sync/models.py in Step 8.
